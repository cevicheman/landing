...
/**
 * Muestra la notificación interactiva en pantallas medianas o mayores.
 * @returns {void}
 */
const showToast = () => {
...
/**
 * Agrega un evento click al botón de demo para abrir un video en una nueva pestaña.
 * @returns {void}
 */
const showVideo = () => {
...
/**
 * Renderiza los primeros 6 productos dentro del contenedor de productos.
 * @returns {void}
 */
...
/**
 * Renderiza las categorías dentro del select correspondiente.
